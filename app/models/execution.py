...
LiveSubmitBlockReason = Literal[
    ...
    "arm_token_required",
    "arm_token_mismatch",
    "arm_token_environment_mismatch",
    "binance_environment_mode_invalid",
    "binance_live_environment_not_enabled",
    "binance_testnet_resolved_to_live_endpoint",
    "binance_symbol_not_in_pilot_allowlist",
