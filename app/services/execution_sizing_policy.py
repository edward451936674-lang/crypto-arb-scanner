...
def build_default_execution_account_inputs() -> ExecutionAccountInputs:
    return ExecutionAccountInputs(
        ...
        live_remaining_total_cap_pct=0.20,
        live_remaining_symbol_cap_pct=0.08,
        live_remaining_long_exchange_cap_pct=0.10,
        live_remaining_short_exchange_cap_pct=0.10,
    )
